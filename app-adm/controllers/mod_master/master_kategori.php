...
class Master_kategori extends GOA_Controller {
	// public variable
	...
	function _loader_class()
	{
		...
		$this->load->model(array(
			"metadata","jqgrid_model","tbl_kategori"
		));
		return false;
	}
	...
	{
		$where['kat_id'] = $dvd_id;
		$get_gambar = $this->tbl_kategori->data_kategori($where);
		if ($get_gambar->row()->kat_gambar != '')
			$this->lib_files->delete_image($get_gambar->row()->kat_gambar,'kategori');
